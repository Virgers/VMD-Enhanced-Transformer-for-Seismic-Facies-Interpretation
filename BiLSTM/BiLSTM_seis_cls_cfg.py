...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', type=str, default='nz')
        ...
        self.parser.add_argument('--checkpoints_test_only', type=str, default='/home/dell/disk1/Jinlong/Time-Series-Library-main/checkpoints/2024-06-14 21:11:58-BiLSTM-dataset_f3-trainproportion_0.01-testproportion_0.01-maskrate_0.125-isvmd_False-embedflag_True-epochs_15-backbone_False-batchsize_16-0/checkpoint.pth', help='location of model checkpoints')
