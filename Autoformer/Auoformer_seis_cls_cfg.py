...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--train_epochs', type=int, default=20, help='train epochs')
        ...
        self.parser.add_argument('--ssl_model_path', type=str, default='/home/dell/disk1/Jinlong/Time-Series-Library-main/checkpoints/2024-06-07 14:25:54-Autoformer-trainproportion_0.8-testproportion_0.1-masktype_random-maskrate_0.25-isvmd_False-embedflag_False-epochs_6-backbone_False-batchsize_256-0/checkpoint.pth', help='for TimesBlock')
        ...
        # self.parser.add_argument('--train_proportion', type=float, default=0.95, help='seismic data for train')
        # self.parser.add_argument('--test_proportion', type=float, default=0.1, help='seismic data for test')
        # self.parser.add_argument('--val_proportion', type=float, default=0.1, help='seismic data for test')
        # self.parser.add_argument('--val_test_proportion', type=float, default=0.1, help='seismic data for test')
        # self.parser.add_argument('--self_supervised_proportion', type=float, default=0.1, help='seismic data for test')
