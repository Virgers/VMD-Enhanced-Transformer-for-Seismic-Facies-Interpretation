...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--checkpoints_test_only', type=str, default='/home/dell/disk1/Jinlong/Time-Series-Library-main/checkpoints/2024-06-12 17:18:43-FEDformer-trainproportion_0.01-testproportion_0.01-masktype_random-maskrate_0.25-isvmd_True-embedflag_True-epochs_14-backbone_False-batchsize_16-0/checkpoint.pth', help='location of model checkpoints')

        # self.parser.add_argument('--vmd_data_path', type=str, default='full_nz_vmd.npy', help='vmd npy data file') # NZ_VMD_facies_randomlu_selected_xline_100_reshaped
        ...
        self.parser.add_argument('--model', type=str,  default='FEDformer',
        ...
        # self.parser.add_argument('--vmd_data_path', type=str, default='full_F3_vmd.npy', help='vmd npy data file') # NZ_VMD_facies_randomlu_selected_xline_100_reshaped
        
        self.parser.add_argument('--ssl_model_path', type=str, default='/home/dell/disk1/Jinlong/Time-Series-Library-main/checkpoints/2024-06-07 19:04:11-FEDformer-trainproportion_0.8-testproportion_0.1-masktype_random-maskrate_0.125-isvmd_False-embedflag_False-epochs_6-backbone_False-batchsize_256-0/checkpoint.pth', help='for TimesBlock')
        ...
        # self.parser.add_argument('--test_proportion', type=float, default=0.001, help='seismic data for test')
        # self.parser.add_argument('--val_proportion', type=float, default=0.01, help='seismic data for test')
        ...
        self.parser.add_argument('--val_proportion', type=float, default=0.0001, help='seismic data for test')
        self.parser.add_argument('--val_test_proportion', type=float, default=0.0001, help='seismic data for test')
        self.parser.add_argument('--self_supervised_proportion', type=float, default=0.0001, help='seismic data for test')
        ...
        self.parser.add_argument('--mask_type', type=str, default='random', help='mask type')
