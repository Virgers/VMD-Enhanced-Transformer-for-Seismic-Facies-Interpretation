...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--time', type=str,default=datetime.now, help="current of running the experiment")
        ...
        self.parser.add_argument('--output_dir', default='/home/dell/disk1/Jinlong/Time-Series-Library-main', 
        ...
        self.parser.add_argument('--is_testing', type=int,  default=1, help='status')
        ...
        self.parser.add_argument('--model', type=str,  default='Nonstationary_Transformer',
                            help='model name, options: [iTransformer, iInformer, iReformer, iFlowformer, iFlashformer, BiLSTM, Nonstationary_Transformer]')
        ...
        self.parser.add_argument('--use_ssl_model', type=bool, default=False, help='for TimesBlock')
        ...
        self.parser.add_argument('--test_proportion', type=float, default=0.2, help='seismic data for test')
        self.parser.add_argument('--val_proportion', type=float, default=0.001, help='seismic data for test')
        self.parser.add_argument('--train_epochs', type=int, default=14, help='train epochs')
        ...
        self.parser.add_argument('--mask_path', type=str, default='labels_train.npz', help='mask npy file')
        self.parser.add_argument('--vmd_data_path', type=str, default='full_nz_vmd.npy', help='vmd npy data file') 
        # for simplicity we only change this into 1006
        # self.parser.add_argument('--seq_len', type=int, default=255, help='input sequence length')
        self.parser.add_argument('--seq_len', type=int, default=1006, help='input sequence length')
        self.parser.add_argument('--checkpoints_test_only', type=str, default='/home/dell/disk1/Jinlong/Time-Series-Library-main/checkpoints/2024-06-12 13:49:39-Nonstationary_Transformer-trainproportion_0.01-testproportion_0.01-maskrate_0.25-isvmd_True-embedflag_False-epochs_15-backbone_False-batchsize_16-/checkpoint.pth', help='location of model checkpoints')

        # self.parser.add_argument('--checkpoints_test_only', type=str, default='./checkpoints', help='location of model checkpoints')

        self.parser.add_argument('--ssl_model_path', type=str, default='/home/dell/disk1/Jinlong/Time-Series-Library-main/checkpoints/2024-06-07 14:01:09-Nonstationary_Transformer-trainproportion_0.8-testproportion_0.1-masktype_random-maskrate_0.375-isvmd_False-embedflag_False-epochs_6-backbone_False-batchsize_256-0/checkpoint.pth', help='for TimesBlock')

        self.parser.add_argument('--mask_rate', type=float, default=0.25, help='mask ratio')
        
        self.parser.add_argument('--attn_mask_path', type=str, default='train_labels.npy', help='mask npy file')
        # if self supervised learning then task will be imputation
        # self.parser.add_argument('--task_name', type=str, default='imputation')

        # data loader

        """rembember to change botht the flag and data path of the vmd situation"""
        # self.parser.add_argument('--vmd_data_path', type=str, default='VMD_facies_complete.npy', help='vmd npy data file')
        # NZ_VMD_facies_randomlu_selected_xline_100_reshaped
        
        # self.parser.add_argument('--label_path', type=str, default='330NZ_VMD_facies_randomlu_selected_100_selectedlabel.npy', help='label npy file')
        # self.parser.add_argument('--data_path', type=str, default='data_train.npz', help='data npy file')
        ...
        # if new zealand 
        # self.parser.add_argument('--attn_mask_path', type=str, default='labels_train.npz', help='mask npy file')
        

        # self.parser.add_argument('--label_path', type=str, default='label_train.npz', help='label npy file')
        ...
        self.parser.add_argument('--val_test_proportion', type=float, default=0.05, help='seismic data for test')
        ...
        self.parser.add_argument('--p_hidden_dims', type=int, default=[256, 256], help='for TimesBlock')
        self.parser.add_argument('--p_hidden_layers', type=int, default=2, help='for TimesBlock')
