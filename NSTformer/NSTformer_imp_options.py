...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--is_self_supervised', type=int,  default=1, help='status')
        ...
        self.parser.add_argument('--vmd_data_path', type=str, default='330NZ_VMD_facies_randomlu_selected_100_selected.npy', help='vmd npy data file') # NZ_VMD_facies_randomlu_selected_xline_100_reshaped
        self.parser.add_argument('--embedding_flag', type=bool, default=False, help='if set true model apply padding mask as attn mask')
        self.parser.add_argument('--mask_rate', type=int, default=0.5, help='mask rate below is masked')
        self.parser.add_argument('--train_proportion', type=float, default=0.9, help='seismic data for train')
        ...
        self.parser.add_argument('--train_epochs', type=int, default=6, help='train epochs')
        self.parser.add_argument('--use_ssl_model', type=bool, default=False, help='for TimesBlock')
       
        self.parser.add_argument('--ssl_model_path', type=str, default='/home/dell/disk1/Jinlong/Time-Series-Library-main/checkpoints/2024-06-05 16:07:27_self_supervised_iTransformer_TSF_S_ft255_sl100_ll255_pl64_dm8_nh2_el1_dl64_df1_fctimeF_ebTrue_dttest_projection_0/checkpoint.pth', help='for TimesBlock')
