...
We adpat several base models from THUML [Time-Series-Library](https://pan.baidu.com/s/1wydQRBNdyylJZAvxCMjOPA) to adpat into seismic facies classification tasks with following approaches.
And we published our paper at [IEEE TGRS](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10707629) or [Google Drive](https://drive.google.com/file/d/1CX2ve0JFBo0W_jfeplZlK3dtlXqWsZ8-/view?usp=drive_link).
