# Seismic VMD Batch Processor & Visualizer
# Quick Start
# Prepare your data:

# Place your seismic data files (.npy or .npz) in the correct directories.
# Update file paths in the script as needed for your dataset.
# Batch VMD Decomposition:

# python utils/generate_vmd.py
# This will perform Variational Mode Decomposition (VMD) on all traces and save the decomposed results as a NumPy file.
# Visualization (Optional):

# The script also generates visualizations for selected traces, saving them as PNG images for inspection.
# Output
# VMD Results: Decomposed Intrinsic Mode Functions (IMFs) for each trace, saved as a .npy file.
# Visualizations: PNG images showing original signals, IMFs, and reconstruction for selected traces.
# Logs: Console output for progress and completion status.
