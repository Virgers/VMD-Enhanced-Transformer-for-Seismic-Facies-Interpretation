...
# from utils.model_analysis import analyze_model_structure
# Analyze your PyTorch model:

# model = YourPyTorchModel()
# analyze_model_structure(model, save_path='./output/model_analysis')
# View results:

# Check the generated files in your specified output directory
# Results available in multiple formats (CSV, LaTeX, Markdown, and TXT)
# Output
# CSV file: Detailed layer-by-layer breakdown
# LaTeX table: Publication-ready model architecture table
# Markdown table: For documentation and GitHub READMEs
# Summary text file: Key statistics including parameter counts
