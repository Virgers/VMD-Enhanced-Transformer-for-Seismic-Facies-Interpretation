...
def visualize_vmd_results(trace_index, u, original_signal):
    ...
    ax5.plot(original_signal, 'b', linewidth=0.5, label='Original')
    ax5.plot(reconstructed_signal, 'r-', linewidth=0.5, label='Reconstructed')
    # Plot reconstruction error
    ax5.plot(error, 'g:', linewidth=0.5, label='Error')
