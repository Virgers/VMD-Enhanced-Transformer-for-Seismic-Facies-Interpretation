...
if __name__ == "__main__":
    ...
    #     features = [f'Trace_{j}_Inline_{il}_Crossline_{xl}' for il, xl in positions]
        # pairplot, correlation_fig = create_visualization(df_list[0], features, 'label')
    pairplot, correlation_fig = create_visualization(df_list[0])
