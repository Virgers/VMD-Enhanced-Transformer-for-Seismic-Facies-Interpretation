...
filepath = '/home/dell/disk1/Jinlong/faciesdata/labels.npy'
...
def create_visualization(data, file_name):
    ...
    plt.tight_layout()
    plt.savefig(f'../output/figures/Horizon_{file_name}_correlation_matrix.png')
    # plt.show()
...
if __name__ == "__main__":
    ...
    seismic_labels = np.load('/home/dell/disk1/Jinlong/Horizontal-data/train_label_no_ohe.npy')
