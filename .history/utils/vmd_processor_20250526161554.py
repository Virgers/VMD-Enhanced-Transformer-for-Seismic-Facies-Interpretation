...
# Required files:
# train_labels.npy (F3 facies data)
# data_train.npz (NZ facies data)
# Ensure files are in specified paths:
# python
# /home/dell/disk1/Jinlong/faciesdata/train_labels.npy
# /home/dell/disk1/Jinlong/faciesdata/data_train.npz
# Run the script:
...
# Output
# VMD files:
# full_F3_vmd.npy (saved in working directory)
# Visualization:
# vmd_visualization_trace_*.png (for sample traces 0, 2, 8)
# Process:
# Decomposes seismic signals into 8 IMFs using VMD
# Visualizes original signal vs reconstructed signal
