...
class Options(object):
    ...
    def __init__(self):
        ...
        # keep the vmd and embed flag coherent with the setting and model weights
        ...
        self.parser.add_argument('--checkpoints_test_only', type=str, default='/home/dell/disk1/Jinlong/Time-Series-Library-main/checkpoints/2024-07-06 10:41:48-iTransformer-dataset_nz-trainproportion_0.01-testproportion_0.1-maskrate_0.125-isvmd_False-embedflag_False-epochs_14-backbone_False-batchsize_16-0/checkpoint.pth', help='location of model checkpoints')
        ...
        self.parser.add_argument('--dataset', type=str, default='nz', help='data file')
        ...
        # self.parser.add_argument('--mask_path', type=str, default='train_labels.npy', help='label npy file')
        ...
        # NZ_VMD_facies_randomlu_selected_xline_100_label_reshaped
        # vmd--label2 data2--label
        ...
        # self.parser.add_argument('--label_path', type=str, default='labels.npy', help='label npy file')

        # labels2 prepared for vmd 
        # self.parser.add_argument('--label2_path', type=str, default='labels.npy', help='label npy file')

        # self.parser.add_argument('--mask_path', type=str, default='mask_kmeans.npy', help='mask npy file')

        self.parser.add_argument('--attn_mask_path', type=str, default='labels.npy', help='mask npy file')

        # self.parser.add_argument('--label_path', type=str, default='NZ_VMD_facies_randomlu_selected_10_label.npy', help='label npy file')
        # # labels2 prepared for vmd 

        # # self.parser.add_argument('--mask_path', type=str, default='mask_kmeans.npy', help='mask npy file')
        # self.parser.add_argument('--mask_path', type=str, default='NZ_VMD_facies_randomlu_selected_10_label.npy', help='mask npy file')
        # self.parser.add_argument('--attn_mask_path', type=str, default='NZ_VMD_facies_randomlu_selected_10_label.npy', help='mask npy file')
